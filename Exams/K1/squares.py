...
class Squares(Problem):
    ...
    def successor(self, state):
        succ = {}
        #gore dolu levo desno
        kvadratche1_curr = state[0]
        kvadratche2_curr = state[1]
        kvadratche3_curr = state[2]
        kvadratche4_curr = state[3]
        kvadratche5_curr = state[4]
        
        kvadratche1_goal = self.goal[0]
        kvadratche2_goal = self.goal[1]
        kvadratche3_goal = self.goal[2]
        kvadratche4_goal = self.goal[3]
        kvadratche5_goal = self.goal[4]
        
        if kvadratche1_curr != kvadratche1_goal:
            new_position = (kvadratche1_curr[0], kvadratche1_curr[1] + 1)
            new_state = (new_position, kvadratche2_curr, kvadratche3_curr, kvadratche4_curr, kvadratche5_curr)
            ...
            new_position = (kvadratche1_curr[0] - 1, kvadratche1_curr[1])
            new_state = (new_position, kvadratche2_curr, kvadratche3_curr, kvadratche4_curr, kvadratche5_curr)
            if self.check_valid(new_state):
        ...
        if kvadratche2_curr != kvadratche2_goal:
            new_position = (kvadratche2_curr[0], kvadratche2_curr[1] + 1)
            new_state = (kvadratche1_curr, new_position, kvadratche3_curr, kvadratche4_curr, kvadratche5_curr)
            if self.check_valid(new_state):
            ...
            new_position = (kvadratche2_curr[0] - 1, kvadratche2_curr[1])
            new_state = (kvadratche1_curr, new_position, kvadratche3_curr, kvadratche4_curr, kvadratche5_curr)
            if self.check_valid(new_state):
        ...
        if kvadratche3_curr != kvadratche3_goal:
            new_position = (kvadratche3_curr[0], kvadratche3_curr[1] + 1)
            new_state = (kvadratche1_curr, kvadratche2_curr, new_position, kvadratche4_curr, kvadratche5_curr)
            if self.check_valid(new_state):
            ...
            new_position = (kvadratche3_curr[0] - 1, kvadratche3_curr[1])
            new_state = (kvadratche1_curr, kvadratche2_curr, new_position, kvadratche4_curr, kvadratche5_curr)
            if self.check_valid(new_state):
        ...
        if kvadratche4_curr != kvadratche4_goal:
            new_position = (kvadratche4_curr[0], kvadratche4_curr[1] + 1)
            new_state = (kvadratche1_curr, kvadratche2_curr, kvadratche3_curr , new_position, kvadratche5_curr)
            if self.check_valid(new_state):
            ...
            new_position = (kvadratche4_curr[0] - 1, kvadratche4_curr[1])
            new_state = (kvadratche1_curr, kvadratche2_curr, kvadratche3_curr , new_position, kvadratche5_curr)
            if self.check_valid(new_state):
        ...
        if kvadratche5_curr != kvadratche5_goal:
            new_position = (kvadratche5_curr[0], kvadratche5_curr[1] + 1)
            new_state = (kvadratche1_curr, kvadratche2_curr, kvadratche3_curr, kvadratche4_curr, new_position)
            if self.check_valid(new_state):
            ...
            new_position = (kvadratche5_curr[0] - 1, kvadratche5_curr[1])
            new_state = (kvadratche1_curr, kvadratche2_curr, kvadratche3_curr, kvadratche4_curr, new_position)
            if self.check_valid(new_state):
...
if __name__ == '__main__':
    ...
    bfs = breadth_first_graph_search(squares)
